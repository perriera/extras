...
>
> > git tag -a v8.27.6 -m "refactored code"</br>
> > git push origin v8.27.6
>
> > POPULAR LINKS:
...
#### 8.16.1 (2023-05-04)
### Refactored 
- added mogrify -format jpg *.png

#### 8.16.0 (2023-05-04)
### Refactored 
- added docs/IMAGES.md
...
[unreleased]: https://github.com/perriera/extras/compare/v8.27.6..HEAD
