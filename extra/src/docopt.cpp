...
#include "../include/extra/docopt.h"
#include "../include/extra/docopt_private.h"
#include "../include/extra/docopt_util.h"
#include "../include/extra/docopt_value.h"
...
std::vector<Option> parse_defaults(std::string const &doc) {
  ...
  // The delimiter is a new line followed by a whitespace(s) followed by one or
  // two hyphens.
